...
programs="auction-house auctioneer bubblegum candy-machine candy-machine-core dutch fixed-price-sale gumdrop hydra nft-packs token-entangler token-metadata"
